    ...
    <div className="bg-white min-h-screen w-full p-4 md:p-6">
      <div className="w-full flex flex-col gap-4">
        <div className="flex items-center gap-3">
          <i
            onClick={() => navigate(-1)}
            className="ri-arrow-left-line p-2 md:p-3 text-gray-700 text-xl md:text-2xl cursor-pointer"
          ></i>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900">
            Must-See TV
            <small className="ml-1 md:ml-2 text-base md:text-lg text-gray-600"></small>
          </h1>
        </div>
